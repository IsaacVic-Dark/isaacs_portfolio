...
const TcProj = () => {
  ...
  const features = [
    {
      ...
      title: "Monthly Tax Calculation",
      description:
        "Calculates PAYE based on user income input for both monthly and annual periods.",
    },
    {
      icon: <Calculator className="w-6 h-6" />,
      title: "Progressive Tax Bracket Logic",
      description:
        "Accurately applies KRA’s tiered tax bands, including personal relief and deductions.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Automatically calculate tax deductions, insurance, and other contributions.",
    },
    {
      icon: <Calendar className="w-6 h-6" />,
      title: "User-friendly Interface",
      description:
        "Simple, clean layout with clear input fields and instant results display.",
    },
    {
      icon: <Award className="w-6 h-6" />,
      title: "Error Handling and Validation",
      description:
        "Prevents incorrect input through basic validation (e.g., negative numbers, empty fields).",
    },
  ];

  const techStack = [
    { name: "PHP", category: "Logic", color: "#decfb8" },
  ...
  const mockImages = [
    ...
    },
    {
      ...
      type: "mobile",
      url: "/src/assets/ketaxmobile.png",
    },
    {
      id: 3,
      title: "Mobile Interface",
      type: "mobile",
      url: "/src/assets/ketax.png",
    },
  ];
  ...
  const challenges = [
    {
      ...
      solution:
        "Implemented automated calculation engine for overtime, bonuses, and various deduction types with configurable rules.",
    },
    {
      title: "Tax Compliance",
      solution:
        "Built flexible tax calculation system that adapts to different tax brackets and regulatory requirements.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f5f2eb] to-[#ede6d3]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              />
              <h1 className="text-5xl font-bold mb-4">Kenya Tax Calculator</h1>
            </div>
            <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
              A simple, user-friendly web application that helps individuals in
              Kenya calculate their monthly or annual income tax based on the
              progressive tax system defined by the Kenya Revenue Authority
              (KRA).
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="https://github.com/IsaacVic-Dark/Kenya-Tax-Calculator.git"
                target="_blank"
              ...
              <button className="inline-flex items-center px-6 py-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg hover:bg-opacity-30 transition-colors">
                ...
                <a
                  href="https://kenya-tax-calculator.onrender.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Live Demo
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {activeTab === "overview" && (
          <div className="space-y-12">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-[#5a4a3a] mb-6">
                  Project Overview
                </h2>
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  A simple, responsive web app built with PHP, HTML, and CSS to
                  help individuals in Kenya calculate their monthly or annual
                  income tax based on KRA’s progressive tax system. It applies
                  the correct tax bands, personal relief, and deductions to
                  provide accurate, real-time PAYE estimates in a user-friendly
                  interface.
                </p>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-white bg-opacity-60 p-4 rounded-lg border border-[#decfb8]">
                    <h4 className="font-semibold text-[#5a4a3a] mb-2">
                      Duration
                    </h4>
                    <p className="text-gray-600">A day</p>
                  </div>
                  <div className="bg-white bg-opacity-60 p-4 rounded-lg border border-[#decfb8]">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-[#decfb8] to-[#d4c5a9] p-8 rounded-2xl shadow-xl">
                  <div className="bg-white bg-opacity-50 p-6 rounded-xl">
                    <h3 className="text-xl font-bold text-[#5a4a3a] mb-4">
                      Key Achievements
                    </h3>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        ...
                        <span>
                          Accurately Implemented KRA Tax Logic
                        </span>
                      </li>
                      <li className="flex items-start">
                        <ChevronRight className="w-5 h-5 text-[#5a4a3a] mt-0.5 mr-2 flex-shrink-0" />
                        <span>
                          Built a Clean, Responsive Interface
                        </span>
                      </li>
                      <li className="flex items-start">
                        <ChevronRight className="w-5 h-5 text-[#5a4a3a] mt-0.5 mr-2 flex-shrink-0" />
                        <span>
                          Delivered Real-time, Error-free Calculations
                        </span>
                      </li>
                    </ul>
                  </div>
        ...
        {activeTab === "features" && (
          <div>
            <h2 className="text-3xl font-bold text-[#5a4a3a] mb-8 text-center">
              Core Features
            </h2>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-[#5a4a3a]">
                      {feature.title}
                    </h3>
                  </div>
        ...
        {activeTab === "tech" && (
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-semibold text-[#5a4a3a] mb-6">
                  Technologies Used
                </h3>
                <div className="space-y-4">
                  {techStack.map((tech, index) => (
                    ...
                    >
                      <div>
                        <h4 className="font-semibold text-[#5a4a3a]">
                          {tech.name}
                        </h4>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {mockImages.map((image) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-[#5a4a3a]">
                      {image.title}
                    </h3>
        ...
        {activeTab === "challenges" && (
          <div>
            ...
            <div className="space-y-8">
              {challenges.map((challenge, index) => (
                ...
                >
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-xl font-semibold text-[#5a4a3a] mb-4">
                        Challenge
                      </h3>
                      <p className="text-gray-700 leading-relaxed">
                        {challenge.title}
            ...
            <div className="mt-12 bg-gradient-to-r from-[#decfb8] to-[#d4c5a9] p-8 rounded-2xl text-center">
              <h3 className="text-2xl font-bold text-[#5a4a3a] mb-4">
                What I Learned
              </h3>
              <p className="text-gray-700 max-w-3xl mx-auto leading-relaxed">
                From building the KRA Income Tax Calculator, I learned how to
                implement Kenya’s progressive tax system using clean,
                logic-driven code and gained a deeper understanding of tax
                brackets, reliefs, and deductions. I improved my skills in form
                validation, responsive UI design, and interactive state
                management, while ensuring accurate, real-time calculations. The
                project also taught me how to create user-friendly interfaces,
                test for accuracy, and deploy optimized web applications that
